...
class facial_recognition(Frame):
    ...
    def load_face_encodings(self) -> None:
        ...
        obama_image: face_recognition.ndarray = face_recognition.load_image_file("obama.jpg")
        obama_face_encoding = face_recognition.face_encodings(obama_image)[0]

        # Load a second sample picture and learn how to recognize it.
        biden_image: face_recognition.ndarray = face_recognition.load_image_file("biden.jpg")
    ...
    def display_recognition(self) -> None:
        ...
        if self.process_this_frame:
            ...
            for face_encoding in self.face_encodings:
                ...
                # # If a match was found in self.known_faces, just use the first one.
                # if True in matches:
...
# Create the facial recognition frame
facial_recognition_frame = facial_recognition(root)
